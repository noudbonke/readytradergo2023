                                         ...
                                         const std::array<unsigned long, TOP_LEVEL_COUNT>& bidVolumes)
{
    ...
    if (instrument == Instrument::ETF){
        ...
        if (mAskId == 0 && arbitrageAskPrice != 0 && mPosition > -POSITION_LIMIT)
        {
            ...
            SendInsertOrder(mAskId, Side::SELL, arbitrageAskPrice, std::min((signed int)(LOT_SIZE*askDiff), POSITION_LIMIT + (int)mPosition), Lifespan::FILL_AND_KILL);
        ...
        if (mBidId == 0 && arbitrageBidPrice != 0 && mPosition < POSITION_LIMIT)
        {
            ...
            SendInsertOrder(mBidId, Side::BUY, arbitrageBidPrice, std::min((signed int)(LOT_SIZE*bidDiff), POSITION_LIMIT - (int)mPosition), Lifespan::FILL_AND_KILL);
